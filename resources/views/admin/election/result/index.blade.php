...
<div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Election Result Report</li>
        </ol>
    </div>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-green-sharp">
                                    ...
                                    <span class="caption-subject bold uppercase">Election Result Report</span>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="tabbable-custom nav-justified">
                                                ...
                                                <div class="tab-content">
                                                    @include('admin.election.result.partials._state_level')
                                                    @include('admin.election.result.partials._lga_level')
                                                    @include('admin.election.result.partials._ward_level')
                                                    @include('admin.election.result.partials._polling_station')
                                                </div>
                                            </div>
                                        </div>
                                    </div>
