...
<div class="modal" id="new-polling" tabindex="-1" role="dialog" aria-labelledby="modal-large" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title"><i class="si si-user"></i> Add New PollingStation</h3>
                    ...
                    <div class="card card-body">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control form-input" name="ward" id="ward" required>
                                    <option>Wards</option>
                                </select>
                            </div>
                        </div> 
